...
::::{.columns}
::: {.column width="30%"}
&lt;div class="right-centered-text">![](../../resources/ontotext.png)&lt;/div>
:::
::: {.column width="70%"}
More text goes here...
:::
...
## Quarto side notes and footnotes
...
- Also it is possible to have a footnote in a traditional markdown. Here is a footnote reference,<pre>[^1]</pre> and another <pre>[^longnote]</pre>
...
| | | | 
|-|-|-|
| Developed by   | ![](../../resources/ontotext.png){width=200px} | [Ontotext AD](https://ontotext.com/) |                                                                 |
